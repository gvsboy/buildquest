...
Builder = React.createClass({
  ...
  modules: {
    QuestList:  React.createElement(QuestList, {key: "module-questList"}),
    Quest:      React.createElement(Quest, {key: "module-quest"})
  },
  ...
  render: function() {
    ...
    return (
      ...
      React.createElement("div", {id: "module-builder"}, 
        React.createElement("h1", {className: "animated bounceInDown"}, "QuestBuilder"), 
        module
      )
...
},{"./Quest":150,"./QuestList":151,"lodash":2,"react":148}],150:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react'),
    _ = require('lodash');
...
},{"lodash":2,"react":148}],151:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react');
  ...
  render: function() {
    return (
      ...
      React.createElement("div", {id: "module-questList"}, 
        React.createElement("button", {className: "pure-button pure-button-primary", onClick: this.handleClick}, 
          "+ Create a New Quest"
        )
      )
...
React.render(React.createElement(Builder, null), document.body);

},{"./Builder":149,"react":148}]},{},[152]);
